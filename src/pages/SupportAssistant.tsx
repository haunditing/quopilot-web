...
function SupportAssistantPanel() {
  ...
  async function handleConfirmCase(caseDoc: SupportCase) {
    try {
      ...
      toast.error(
        error instanceof Error ? error.message : "No fue posible verificar",
      );
    }
  }
  ...
  return (
    <main className="assistant-chat">
          ...
          <section className="settings-card">
            ...
            {docsLoading ? (
              ...
              <EmptyState
                ...
                message="Agrega documentos para que el asistente pueda responder con conocimiento verificado."
              />
            )}
          </section>
        )}
        ...
        {activeTab === "cases" && (
          <section className="settings-card">
            <header className="settings-card__header">
              ...
              <Button icon="plus" iconOnly onClick={() => openCaseModal()}>
                Nuevo caso
              </Button>
            </header>
            ...
            {casesLoading ? (
                ...
                {cases.map((caseDoc) => (
                  <li key={caseDoc._id} className="support-admin__item">
                    ...
                    <div className="support-admin__item-meta">
                      ...
                      <span className="cell-sub">
                        {caseDoc.confirmedCount} confirmaciones
                      </span>
              ...
              <EmptyState
                title="Sin casos"
                message="Agrega casos resueltos para que el asistente los reutilice como fuente primaria."
              />
            )}
          </section>
        )}
        ...
        <form className="modal__form" onSubmit={handleSaveKnowledge}>
          <div className="form-card__grid">
            ...
            <div className="form-field">
              ...
              <select
                id="kb-enabled"
                value={knowledgeForm.enabled ? "1" : "0"}
                onChange={(event) =>
      ...
      <Modal
        open={caseModalOpen}
        title={editingCase ? "Editar caso" : "Nuevo caso"}
      ...
      >
        <form className="modal__form" onSubmit={handleSaveCase}>
          ...
          <Button type="submit" icon="check" iconOnly disabled={caseSaving}>
